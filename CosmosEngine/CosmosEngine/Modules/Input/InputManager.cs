...
{
	/// <summary>
	/// <see cref="CosmosEngine.InputManager"/> is a beginner friendly input system, than the more advanced <see cref="CosmosEngine.InputSystem"/>. With the benefit of predefined input buttons and less setup.
	/// </summary>
