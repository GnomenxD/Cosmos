namespace CosmosEngine
{
	...
	{
		/// <summary>
		/// <inheritdoc cref="CosmosEngine.Mathf.ClampBetween(int, int, int)"/>
		/// </summary>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosEngine.Random.Range(int, int)"/>
		/// </summary>
		public static int RandomInRange(this MinMaxInt minMax) => Random.Range(minMax.Min, minMax.Max);
		/// <summary>
		/// <inheritdoc cref="CosmosEngine.Random.Range(float, float)"/>
		/// </summary>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosEngine.Mathf.Lerp(float, float, float)"/>
		/// </summary>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosEngine.Mathf.LerpUnclamped(float, float, float)"/>
		/// </summary>
