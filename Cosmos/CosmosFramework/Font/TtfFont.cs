...
namespace CosmosFramework.Text
{
	internal class TtfFont
	{
		...
		public TtfFont(Dictionary<int, GlyphInfo> glyphs,
		...
		public SpriteFont CreateSpriteFont(GraphicsDevice graphicsDevice)
		{
			...
			foreach (var key in orderedKeys)
			{
				...
				cropping.Add(new Rectangle((int)character.OffsetX,
					character.OffsetY,
					bounds.Width, bounds.Height));

				chars.Add((char)key);

				kerning.Add(new Vector3(0, bounds.Width, character.AdvanceX - bounds.Width));
			}
