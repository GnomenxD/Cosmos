...
namespace CosmosFramework
{
	public sealed class Font : Resource
	{
		...
		public static Font Montserrat => montserrat ??= new Font("resources/fonts/montserrat");
		public static Font TrebuchetMS => trebuchet ??= new Font("resources/fonts/trebuc");
		public static Font Verdana => verdana ??= new Font("resources/fonts/verdana");
		#endregion
		...
		/// <summary>
		/// Returns the size of the contents of the <paramref name="text"/>, as a <see cref="CosmosFramework.Vector2"/>, when rendered in this font at the last used Font Size.
		/// </summary>
		/// <param name="text"></param>
		/// <returns></returns>
		public Vector2 MeasureString(string text) => MeasureString(text, lastUsedFontSize);
		/// <summary>
		/// Returns the size of the contents of the <paramref name="stringBuilder"/>, as a <see cref="CosmosFramework.Vector2"/>, when rendered in this font at the last used Font Size.
		/// </summary>
		/// <param name="stringBuilder"></param>
		/// <returns></returns>
		public Vector2 MeasureString(System.Text.StringBuilder stringBuilder) => MeasureString(stringBuilder, lastUsedFontSize);
		/// <summary>
		/// Returns the size of the contents of the <paramref name="text"/>, as a <see cref="CosmosFramework.Vector2"/>, when rendered in this font at the given <paramref name="size"/>.
		/// </summary>
		/// <param name="text"></param>
		/// <param name="size"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Returns the size of the contents of the <paramref name="stringBuilder"/>, as a <see cref="CosmosFramework.Vector2"/>, when rendered in this font at the given <paramref name="size"/>.
		/// </summary>
		/// <param name="stringBuilder"></param>
		/// <param name="size"></param>
		/// <returns></returns>
