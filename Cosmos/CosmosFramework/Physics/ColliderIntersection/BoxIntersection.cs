...
namespace CosmosFramework.PhysicsModule
{
	public static partial class PhysicsIntersection
	{
		...
		/// <inheritdoc cref="BoxBox(BoxCollider, BoxCollider)"/>
		/// </summary>
		/// <param name="posA">First box center position as a <see cref="CosmosFramework.Vector2"/></param>
		/// <param name="sizeA">First box size as a <see cref="CosmosFramework.Vector2"/></param>
		/// <param name="posB">Second box center position as a <see cref="CosmosFramework.Vector2"/></param>
		/// <param name="sizeB">Second box size as a <see cref="CosmosFramework.Vector2"/></param>
		/// <returns></returns>
