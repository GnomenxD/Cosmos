...
{
	/// <summary>
	/// <see cref="CosmosFramework.Modules.RenderManager"/> handles all <see cref="IRenderWorld"/> and <see cref="IRenderUI"/> and render calls. <see cref="CosmosFramework.Modules.RenderManager"/> runs on a different <see cref="System.Threading.Thread"/> to handle culling and passing the <see cref="CosmosFramework.CoreModule.IRenderer"/> to the Render/Draw method.
	/// </summary>
