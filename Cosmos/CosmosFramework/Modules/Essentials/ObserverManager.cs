...
namespace CosmosFramework.Modules
{
	...
	public abstract class ObserverManager<TItem, TManager> : GameModule<TManager>, IUpdateModule where TManager : ObserverManager<TItem, TManager>, new()
	{
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.CoreModule.ObserverManager{TItem, TManager}.UnsubscribeItem(TItem)"/>
		/// </summary>
		/// <param name="item"></param>
