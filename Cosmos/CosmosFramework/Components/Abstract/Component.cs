...
namespace CosmosFramework
{
	public abstract class Component : Behaviour
	{
		...
		/// <summary>
		/// The name of the <see cref="CosmosFramework.GameObject"/> this <see cref="CosmosFramework.Component"/> is attached to.
		/// </summary>
		public override string Name { get => GameObject == null ? GetType().Name : GameObject.Name; set => GameObject.Name = value; }
		/// <summary>
		/// The enabled state of a <see cref="CosmosFramework.Component"/> is determined by its <see cref="CosmosFramework.GameObject"/> and its own enabled state. If the <see cref="CosmosFramework.GameObject"/> is disabled this <see cref="CosmosFramework.Component"/> will also be seen as disabled. To see the component's own enabled state use <see cref="CosmosFramework.Component.Active"/>.
		/// </summary>
		...
		/// <summary>
		/// Method invoked when this <see cref="CosmosFramework.Component"/> has been assigned its <see cref="CosmosFramework.GameObject"/>. Method is invoked before Awake, it's possible to override but requires base call.
		/// </summary>
