...
namespace CosmosFramework
{
	public class Transform : Component
	{
		...
		/// <summary>
		/// When the <see cref="CosmosFramework.Transform"/> values changes, it should be marked using Dirty() for UpdateEvent to be invoked.
		/// </summary>
		private event Action transformUpdateEvent;

		/// <summary>
		/// The world space position of the <see cref="CosmosFramework.Transform"/>.
		/// </summary>
		...
		/// <summary>
		/// The position of the <see cref="CosmosFramework.Transform"/> relative to the <see cref="CosmosFramework.Transform.Parent"/>.
		/// </summary>
		...
		/// <summary>
		/// The world space rotation in degree of the <see cref="CosmosFramework.Transform"/>.
		/// </summary>
		...
		/// <summary>
		/// The rotation of the <see cref="CosmosFramework.Transform"/> relative to the <see cref="CosmosFramework.Transform.Parent"/>.
		/// </summary>
		...
		/// <summary>
		/// The global scale of the <see cref="CosmosFramework.Transform"/>.
		/// </summary>
		...
		/// <summary>
		/// The scale of the <see cref="CosmosFramework.Transform"/> relative to the <see cref="CosmosFramework.Transform.Parent"/>.
		/// </summary>
		...
		/// <summary>
		/// Event invoked when the <see cref="CosmosFramework.Transform"/> position, rotation or scale changes.
		/// </summary>
		...
		/// <summary>
		/// Marks the <see cref="CosmosFramework.Transform"/> as dirty which will invoke <see cref="CosmosFramework.Transform.TransformUpdateEvent"/>.
		/// </summary>
		protected virtual void Dirty() => TransformUpdateEvent.Invoke();//dirty = true;

		/// <summary>
		/// Resets the <see cref="CosmosFramework.Transform"/> position, rotation and scale to default values.
		/// </summary>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Transform.SetParent(Transform, bool)"/>
		/// </summary>
		/// <param name="newParent">The parent Transform to use.</param>
		public void SetParent(Transform newParent) => SetParent(newParent, true);
		/// <summary>
		/// Set the parent of the transform. It is the same as setting the Parent property except that it also lets the <see cref="CosmosFramework.Transform"/> keep its local orientation rather than its global orientation. This means for example, if the <see cref="CosmosFramework.GameObject"/> was previously next to its parent, setting <paramref name="worldPositionStays"/> to false will move the <see cref="CosmosFramework.GameObject"/> to be positioned next to its new parent in the same way. The default value of <paramref name="worldPositionStays"/> argument is <see langword="true"/>.
		/// </summary>
		/// <param name="newParent">The parent Transform to use.</param>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Transform.Translate(Vector2)"/>
		/// </summary>
		/// <param name="translation">The translation applied to the transform's position.</param>
		/// <param name="relativeTo">If <paramref name="relativeTo"/> is set to <see cref="CosmosFramework.Space.Self"/> the movement is applied relative to the transform's local axes. If <paramref name="relativeTo"/> is set to <see cref="CosmosFramework.Space.World"/> the movement is applied relative to the world coordinate system. </param>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Transform.Translate(float, float)"/>
		/// </summary>
		/// <param name="x">The translation applied to the transform's x axis.</param>
		/// <param name="y">The translation applied to the transform's y axis.</param>
		/// <param name="relativeTo">If <paramref name="relativeTo"/> is set to <see cref="CosmosFramework.Space.Self"/> the movement is applied relative to the transform's local axes. If <paramref name="relativeTo"/> is set to <see cref="CosmosFramework.Space.World"/> the movement is applied relative to the world coordinate system. </param>
		...
		/// <returns>Returns <see langword="true"/> if the <see cref="CosmosFramework.Transform"/> is pointed towards <paramref name="point"/> within a narrow margin of error.</returns>
