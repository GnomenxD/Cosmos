...
namespace CosmosFramework.UI
{
	public class RectTransform : Transform, IUIComponent
	{
		...
		/// <summary>
		/// The size of this <see cref="CosmosFramework.UI.RectTransform"/> relative to the distances between the anchors.
		/// </summary>
		...
		/// <summary>
		/// The position of the pivot of this <see cref="CosmosFramework.UI.RectTransform"/> relative to the anchor reference point.
		/// </summary>
		...
		/// <summary>
		/// The normalized position in this <see cref="CosmosFramework.UI.RectTransform"/> that it rotates around.
		/// </summary>
