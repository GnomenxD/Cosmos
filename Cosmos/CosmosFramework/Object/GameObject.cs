...
{
	/// <summary>
	/// A <see cref="CosmosFramework.GameObject"/> represents a scene object, the <see cref="CosmosFramework.GameObject"/> behaviour is represented by the <see cref="CosmosFramework.Component"/> which are attached to it.
	/// </summary>
	public sealed class GameObject : Behaviour
	{
		...
		/// <summary>
		/// The tag of this <see cref="CosmosFramework.GameObject"/>. A tag can be used to identify a game object.
		/// </summary>
		public string[] Tag 
		{ 
			get => tag.ToArray();
		...
		/// <summary>
		/// The <see cref="CosmosFramework.Transform"/> attached to the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		public override Transform Transform => transform ??= ReplaceTransform<Transform>();
		/// <summary>
		/// An event invoked whenever changes happen to this <see cref="CosmosFramework.GameObject"/>, such as a <see cref="CosmosFramework.Component"/> being added or removed.
		/// </summary>
		...
		#region Constructor
		/// <summary>
		/// Creates a new empty <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		public GameObject()
		{
		...
		/// <summary>
		/// Creates a new empty <see cref="CosmosFramework.GameObject"/> with a given <paramref name="name"/>.
		/// </summary>
		/// <param name="name">The name that the <see cref="CosmosFramework.GameObject"/> is created with.</param>
		...
		/// <summary>
		/// Creates a new <see cref="CosmosFramework.GameObject"/> with a given <paramref name="name"/> and a list of <see cref="CosmosFramework.Component"/> that will be added at instantiation.
		/// </summary>
		/// <param name="name">The name that the <see cref="CosmosFramework.GameObject"/> is created with.</param>
		/// <param name="components">A list of <see cref="CosmosFramework.Component"/> to add to the <see cref="CosmosFramework.GameObject"/> on creation.</param>
		...
		/// <summary>
		/// Replaces <see langword="this"/> game object's <see cref="CosmosFramework.Transform"/> with the <paramref name="newTransform"/>. If <paramref name="keepWorldSpace"/> is <see langword="true"/> the <paramref name="newTransform"/> values will be copied from the old <see cref="CosmosFramework.Transform"/>.
		/// </summary>
		...
		/// <summary>
		/// Finalise will loop all the components attached to the <see cref="CosmosFramework.GameObject"/> and remove any that is null.
		/// </summary>
		...
		/// <summary>
		/// Activates or Deactivates the <see cref="CosmosFramework.GameObject"/>, depending on the given <see langword="true"/> or <see langword="false"/> <paramref name="value"/>.
		/// </summary>
		...
		/// <summary>
		/// Adds a <see cref="CosmosFramework.Component"/> of type <typeparamref name="T"/> to the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		...
		/// <summary>
		/// Adds a <see cref="CosmosFramework.Component"/> of type <paramref name="componentType"/> to the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		...
		/// <summary>
		/// Adds the <paramref name="component"/> instance to the <see cref="CosmosFramework.GameObject"/> and initializes it.
		/// </summary>
		...
		/// <summary>
		/// Returns the first <see cref="CosmosFramework.Component"/> instance of Type <typeparamref name="T"/>, if the <see cref="CosmosFramework.GameObject"/> has one attached, <see langword="null"/> if it doesn't.
		/// </summary>
		...
		/// <summary>
		/// Returns the first <see cref="CosmosFramework.Component"/> instance of <paramref name="componentType"/>, if the <see cref="CosmosFramework.GameObject"/> has one attached, <see langword="null"/> if it doesn't.
		/// </summary>
		/// <param name="componentType">The type of <see cref="CosmosFramework.Component"/> to retrieve.</param>
		...
		/// <summary>
		/// Returns the first <see cref="CosmosFramework.Component"/> instance of Type <typeparamref name="T"/>, if the <see cref="CosmosFramework.GameObject"/> has one attached, or adds an instance of <typeparamref name="T"/> to the <see cref="CosmosFramework.GameObject"/> if it doesn't.
		/// </summary>
		...
		/// <summary>
		/// Returns the first <see cref="CosmosFramework.Component"/> instance of <paramref name="componentType"/>, if the <see cref="CosmosFramework.GameObject"/> has one attached, or adds an instance of <typeparamref name="T"/> to the <see cref="CosmosFramework.GameObject"/> if it doesn't.
		/// </summary>
		...
		/// <summary>
		/// Returns all <see cref="CosmosFramework.Component"/> instances of Type <typeparamref name="T"/> on the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		/// <typeparam name="T">The type to retrieve.</typeparam>
		/// <returns></returns>
		...
		/// <summary>
		/// Returns all <see cref="CosmosFramework.Component"/> instances of <paramref name="componentType"/> on the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns all <see cref="CosmosFramework.Component"/>s on the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		/// <returns></returns>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.GameObject.SendMessage(string, SendMessageOption, object[])"/>
		/// </summary>
		...
		/// <summary>
		/// Invokes the method named <paramref name="methodName"/> on every <see cref="CosmosFramework.GameBehaviour"/> on the <see cref="CosmosFramework.GameObject"/>.
		/// </summary>
		/// <param name="methodName">	The name of the method to call.</param>
		/// <param name="option">Should an error be raised if the method doesn't exist on the target object?</param>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.GameObject.GameObject"/>
		/// </summary>
		public static GameObject Create() => Create("", null);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.GameObject.GameObject(string)"/>
		/// </summary>
		public static GameObject Create(string name) => Create(name, null);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.GameObject.GameObject(string, Type[])"/>
		/// </summary>
		public static GameObject Create(string name, params Type[] components) => new GameObject(name, components);

		#region Find
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Modules.ObjectManager.Find(string)"/>
		/// </summary>
		public static GameObject Find(string name) => ObjectManager.Find(name);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Modules.ObjectManager.FindGameObjectWithTag(string)"/>
		/// </summary>
		public static GameObject FindGameObjectWithTag(string tag) => ObjectManager.FindGameObjectWithTag(tag);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Modules.ObjectManager.FindGameObjectsWithTag(string)"/>
		/// </summary>
		public static GameObject[] FindGameObjectsWithTag(string tag) => ObjectManager.FindGameObjectsWithTag(tag);
		/// <summary>
		/// Returns true if this <see cref="CosmosFramework.GameObject"/> is tagged with <paramref name="tag"/>.
		/// </summary>
