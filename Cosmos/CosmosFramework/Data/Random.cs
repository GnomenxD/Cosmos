...
namespace CosmosFramework
{
	public static class Random
	{
		...
		/// <summary>
		/// Returns <see langword="true"/> if <see cref="CosmosFramework.Random.Value"/> is above the given percentage must be within [0.0, 1.0]
		/// </summary>
		...
		/// <summary>
		/// Returns <see langword="true"/> if <see cref="CosmosFramework.Random.Value"/> is below the given percentage, within range of [0.0, 1.0].
		/// </summary>
		/// <param name="percent">The percentage in a range of [0.0, 1.0].</param>
		/// <param name="inclusive">If inclusive the value itself will include in the check.</param>
		/// <returns></returns>
