...
{
	/// <summary>
	/// Provides constants and static methods for trigonometric, logarithmic, common mathematical functions, linear interpolation, clamping and other useful functionality to use within the <see cref="CosmosFramework"/>.
