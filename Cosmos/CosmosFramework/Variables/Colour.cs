...
namespace CosmosFramework
{
	...
	public partial struct Colour : IEquatable<Colour>
	{
		...
		public static Colour Random => new Colour(
			CosmosFramework.Random.Range(0, 255),
			CosmosFramework.Random.Range(0, 255),
			CosmosFramework.Random.Range(0, 255));
		...
		/// <summary>
		/// Constructs a new <see cref="CosmosFramework.Colour"/> with given <paramref name="r"/>, <paramref name="g"/>, <paramref name="b"/>, <paramref name="a"/> values.
		/// </summary>
		...
		/// <summary>
		/// Constructs a new <see cref="CosmosFramework.Colour"/> with given <paramref name="r"/>, <paramref name="g"/>, <paramref name="b"/> values.
		/// </summary>
		/// <param name="r">Red component.</param>
		/// <param name="g">Green component.</param>
		/// <param name="b">Blue component.</param>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Colour.Set(float, float, float, float)"/>
		/// </summary>
		/// <param name="r">Red component.</param>
		/// <param name="g">Green component.</param>
		/// <param name="b">Blue component.</param>
		...
		/// <summary>
		/// Creates a new <see cref="CosmosFramework.Colour"/> from a hex string, if hex is incorrect a default white colour will be returned.
		/// </summary>
