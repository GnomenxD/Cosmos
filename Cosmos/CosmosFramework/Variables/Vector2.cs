...
using CosmosFramework.Converter;
using System;
...
namespace CosmosFramework
{
	...
	/// <summary>
	/// <see cref="CosmosFramework.Vector2"/> are scaled in unit space, unlike <see cref="Microsoft.Xna.Framework.Vector2"/> which uses pixel space.
	/// </summary>
	public struct Vector2 : IEquatable<Vector2>
	{
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Equals(object)"/>
		/// </summary>
		...
		/// <summary>
		/// Set <paramref name="x"/> and <paramref name="y"/> components of the <see cref="CosmosFramework.Vector2"/>.
		/// </summary>
		/// <param name="x"></param>
		/// <param name="y"></param>
		...
		/// <summary>
		/// Rounds the x and y components of the <see cref="CosmosFramework.Vector2"/> to nearest <see langword="int"/>.
		/// </summary>
		/// <returns></returns>
		...
		/// <summary>
		/// Creates a new <see cref="CosmosFramework.Vector2"/> that contains a transformation of 2d-vector by the specified <see cref="Microsoft.Xna.Framework.Matrix"/>.
		/// </summary>
		/// <param name="matrix">The transformation.</param>
		/// <returns></returns>
		public Vector2 Transform(Matrix matrix) => Vector2.Transform(this, matrix);
		/// <summary>
		/// Creates a new <see cref="CosmosFramework.Vector2"/> that is rotated by the <paramref name="angle"/>.
		/// </summary>
		...
		/// <summary>
		/// Adds the x and y component of <paramref name="value"/> to the x and y component of the <see cref="CosmosFramework.Vector2"/>.
		/// </summary>
		...
		/// <summary>
		/// Adds <paramref name="value"/> to the x and y component of the <see cref="CosmosFramework.Vector2"/>.
		/// </summary>
		...
		/// <summary>
		/// Subtracts the x and y component of <paramref name="value"/> from the x and y component of the <see cref="CosmosFramework.Vector2"/>.
		/// </summary>
		...
		/// <summary>
		/// Subtracts <paramref name="value"/> from the x and y component of a the <see cref="CosmosFramework.Vector2"/>.
		/// </summary>
		...
		/// <summary>
		/// Multiplies the x and y component of the <see cref="CosmosFramework.Vector2"/> with the x and y component of <paramref name="value"/>.
		/// </summary>
		...
		/// <summary>
		/// Multiplies the <see cref="CosmosFramework.Vector2"/> x and y component with <paramref name="value"/>.
		/// </summary>
		...
		/// <summary>
		/// Divides the x and y component of the <see cref="CosmosFramework.Vector2"/> with the x and y component of <paramref name="value"/>
		/// </summary>
		...
		/// <summary>
		/// Divides the <see cref="CosmosFramework.Vector2"/> x and y component with <paramref name="value"/>.
		/// </summary>
		...
		/// <summary>
		/// Converts a Microsoft.Xna.Framework.Vector2 to <see cref="CosmosFramework.Vector2"/>, the vector is scaled to unit space.
		/// </summary>
		/// <returns></returns>
		...
		/// <summary>
		/// Returns a <see cref="CosmosFramework.Vector2"/> perpendicular to the <paramref name="inDirection"/>. The result is always rotated 90-degrees in a counter-clockwise direction for a 2D coordinate system where the positive Y axis goes up.
		/// </summary>
		...
		/// <summary>
		/// Returns a <see cref="CosmosFramework.Vector2"/> that is made from the smallest components of two vectors.
		/// </summary>
		/// <param name="lhs"></param>
		/// <param name="rhs"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Returns a <see cref="CosmosFramework.Vector2"/> that is made from the largest components of two vectors.
		/// </summary>
		/// <param name="lhs"></param>
		/// <param name="rhs"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Returns a <see cref="CosmosFramework.Vector2"/> which components are rounded to nearest integer.
		/// </summary>
		...
		/// <summary>
		/// Returns an inverted vector. [same as using -<see cref="CosmosFramework.Vector2"/>]
		/// </summary>
		/// <param name="value"></param>
		/// <returns></returns>
		...
		#region Operators
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Abs()"/>
		/// </summary>
		public static Vector2 operator +(Vector2 value) => value.Abs();
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Invert()()"/>
		/// </summary>
		public static Vector2 operator -(Vector2 value) => value.Invert();
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Add(float)"/>
		/// </summary>
		public static Vector2 operator +(Vector2 a, float d) => a.Add(d);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Subtract(float)"/>
		/// </summary>
		public static Vector2 operator -(Vector2 a, float d) => a.Subtract(d);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Multiply(float)"/>
		/// </summary>
		public static Vector2 operator *(Vector2 a, float d) => a.Multiply(d);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Divide(float)"/>
		/// </summary>
		...
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Add(Vector2)"/>
		/// </summary>
		public static Vector2 operator +(Vector2 a, Vector2 b) => a.Add(b);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Subtract(Vector2)"/>
		/// </summary>
		public static Vector2 operator -(Vector2 a, Vector2 b) => a.Subtract(b);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Multiply(Vector2)"/>
		/// </summary>
		public static Vector2 operator *(Vector2 a, Vector2 b) => a.Multiply(b);
		/// <summary>
		/// <inheritdoc cref="CosmosFramework.Vector2.Divide(Vector2)"/>
		/// </summary>
